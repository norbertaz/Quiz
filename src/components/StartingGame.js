...
const StartingGame = ({handleStartGame, setCategoryvalue, setDifficultyvalue}) => (
    ...
    <div className="start-game-container bg-blue-600 p-20 shadow-md rounded-lg text-center flex flex-wrap justify-around">
        ...
        <div className="category-wrapper w-1/2">
            <label htmlFor="category">Category:</label>
            <select name="category" id="category" className="text-black w-1/2" onChange={(e) => setCategoryvalue(e.target.value)}>
        ...
        <div className="Difficulty-wrapper w-1/2">
            <label htmlFor="difficulty">Difficulty:</label>
            <select name="difficulty" id="difficulty" className="text-black w-1/2" onChange={(e) => setDifficultyvalue(e.target.value)} >
